...
describe('util', function () {
  describe('isRenderable', function () {
    ...
    test('should return {true} for React.forwardRef', function () {
      var expected = true;
      var actual = (0, _util.isRenderable)( /*#__PURE__*/(0, _react.forwardRef)(function () {}));
      expect(actual).toEqual(expected);
    });
    test('should return {true} for React.memo', function () {
      var expected = true;
      var actual = (0, _util.isRenderable)( /*#__PURE__*/(0, _react.memo)(function () {}));
      expect(actual).toEqual(expected);
    });
    test('should return {true} for React.lazy', function () {
      var expected = true;
      var actual = (0, _util.isRenderable)( /*#__PURE__*/(0, _react.lazy)(function () {}));
      expect(actual).toEqual(expected);
    });
  });
